...
def train(attn_implementation=None):
    ...
    if training_args.bits in [4, 8]:
        ...
        bnb_model_from_pretrained_args.update(dict(
            ...
            quantization_config=BitsAndBytesConfig(
                load_in_4bit=training_args.bits == 4,
                load_in_8bit=training_args.bits == 8,
                llm_int8_skip_modules=["mm_projector"], # NOTE: Does not convert the mm_projector to int8
    ...
    # NOTE: Our case - openai/clip-vit-large-patch14-336
    if model_args.vision_tower is not None:
        if 'mpt' in model_args.model_name_or_path:
            ...
            # NOTE: attn_implementation is not recognized, currently removing it.
    ...
    if model_args.vision_tower is not None:
        ...
        # NOTE: Below is the decision if to tune the mlp adapter or not.
    ...
    if training_args.bits in [4, 8]:
        ...
        for name, module in model.named_modules():
            # NOTE: which layers are being updated. Will update the layers that are .
